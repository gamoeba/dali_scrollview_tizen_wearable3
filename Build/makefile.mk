...
$(APPFILE) : $(OBJS_FILE) $(UOBJS) $(RS_LIBRARIES_FILE)
	...
	$(call MAKEDIRS,$(@D))
	$(CXX) -o $(APPFILE) @$(OBJS_FILE) $(UOBJS) $(LIBPATHS) -Xlinker --as-needed $(LIBS) $(LINK_FLAGS) $(TC_LINKER_MISC) $(RS_LINKER_MISC) -pie -lpthread --sysroot="$(SYSROOT)" -Xlinker --version-script="$(PROJ_ROOT)/.exportMap" $(RS_LIB_PATHS) @$(RS_LIBRARIES_FILE) -Xlinker -rpath='$$ORIGIN/../lib' -Werror-implicit-function-declaration $(USER_LINK_OPTS)
...
$(APPFILE) : $(OBJS_FILE) $(UOBJS)
	...
	$(call MAKEDIRS,$(@D))
	$(AR) -r $(APPFILE) @$(OBJS_FILE) $(UOBJS) $(AR_FLAGS) $(USER_LINK_OPTS)
	@echo '  Finished building target: $@'
endif
ifeq ($(strip $(APPTYPE)),sharedLib)
$(APPFILE) : $(OBJS_FILE) $(UOBJS) $(RS_LIBRARIES_FILE)
	...
	@echo '  Invoking: C/C++ Linker'
	$(call MAKEDIRS,$(@D))
	$(CXX) -o $(APPFILE) @$(OBJS_FILE) $(UOBJS) $(LIBPATHS) -Xlinker --as-needed $(LIBS) $(LINK_FLAGS) $(TC_LINKER_MISC) $(RS_LINKER_MISC) -shared -lpthread --sysroot="$(SYSROOT)" $(RS_LIB_PATHS) @$(RS_LIBRARIES_FILE) $(USER_LINK_OPTS)
	@echo '  Finished building target: $@'
endif
